...
Run the script passing the target repository source path as the first argument:
    .venv/bin/python3 scripts/analyzer.py <path_to_project>
    .venv/bin/python3  scripts/analyzer.py /Users/petrusca/Google/adk-samples/python/agents/data-science
    .venv/bin/python3 scripts/analyzer.py /Users/petrusca/Google/gcp_python_iam_analyzer/gcp_cost_optimizer_agent
"""
import os
import sys
import time
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python scripts/analyzer.py <path_to_project> [python_env_path]")
        sys.exit(1)
